...
/** Every curated topic that has at least one live post, busiest first: the grid reads as a
 *  ranked "what's active here" list, not the vocabulary's declaration order. Both the
 *  Browse-by-Topic grid and the posts index's "topics" stat read this narrower list: a
 *  zero-post topic is still a real curated topic, but a clickable card
